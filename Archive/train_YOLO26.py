...
def main():
    ...
    # UPDATED: Increased default batch size to 512 (64 per GPU) for the H200s
    ...
    # UPDATED: Default to 'auto' to ensure MuSGD is used for rapid early convergence
    ...
    # UPDATED: Default expanded to use all 8 GPUs
